...
public class SoundPlaybackImpl implements ISoundPlayback {
    private static final String TAG = "PlaybackImpl:Intelli";
    ...
    public void play(int action) {
        Log.d(TAG, "[play] play sound with action " + action);
        mMediaActionSoundPlayer.play(action);
    }

    @Override
    public void play(int resourceId, float volume) {
        Log.d(TAG, "[play] play sound with resourceId " + resourceId + ",volume " + volume);
