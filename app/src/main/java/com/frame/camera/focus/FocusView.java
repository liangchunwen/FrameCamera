...
public class FocusView extends View {
    ...
    private final String TAG = "FocusView:Intelli";
    ...
    public void resetToDefaultPosition() {
        int x = previewWidth*2 / 5 - radiusOuter;
        int y = previewHeight*3 / 4 - radiusOuter;
        this.setTranslationX(x);
        this.setTranslationY(y);
    }
    ...
    public void initFocusArea(int width, int height) {
        ...
        Log.e(TAG, "init focus view:" + previewWidth + "x" + previewHeight);
